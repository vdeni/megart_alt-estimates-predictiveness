...
\begin{frame}
    \begin{center}
        \begin{itemize}
            \item usporedba modela na temelju procijenjene prediktivnosti za
                podatke van prikupljenog uzorka
                {\scriptsize \citep*{vehtariPracticalBayesianModel2017}}
            ...
            \begin{tabular}{lrr}
                model & \(\Delta ELPD_{psis-loo}\) & \(SE_{\Delta}\) \\[1.0em]
                aritmetička sredina & --- & --- \\
                medijan & \(-3.8\) & \(3.2\) \\
                latentna aritmetička sredina & \(-4.5\) & \(4.6\)
            \end{tabular}
        \end{itemize}
    \end{center}
\end{frame}
